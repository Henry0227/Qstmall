$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '轮播图', name: 'carouselUrl', index: 'carouselUrl', width: 120, formatter: coverImageFormatter},
            {label: '跳转链接', name: 'redirectUrl', index: 'redirectUrl', width: 100},
            {label: '排序值', name: 'carouselRank', index: 'carouselRank', width: 80},
    ...
    function coverImageFormatter(cellvalue) {
        return "<img src='" + cellvalue + "' height=\"120\" width=\"180\" alt='coverImage'/>";
    }
